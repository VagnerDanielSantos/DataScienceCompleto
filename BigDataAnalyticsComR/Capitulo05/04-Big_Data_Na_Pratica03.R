...
# Big Data na prática 03 - Mineração de Regra de associação 

# Esse é um material de bônus. 
# Conteúdo sobre este tema pode ser encontrado nos cursos: 
...
# Em R pode-se usar o pacote arules para mineração de regras de associação / MBA. 
...
# Substitui os espaços por underline nos nomes muitos longos
...
# Prepara os dados para mineração das regras de associação
...
# Adiciona um número sequencial por jogador
