...
# Gráficos em linguagem R - Base Plotting System
...
png("D:/BigDataAnalytics/Capitulo04/Arquivos/Grafico01.png", width = 500, height = 500, res = 72)
...
pdf("D:/BigDataAnalytics/Capitulo04/Arquivos/Grafico02.pdf")
...
ablineclip(v=1, lty=1, col="limegreen", lwd=2)
ablineclip(v=2, lty=1, col="turquoise", lwd=2)
ablineclip(v=3, lty=1, col="wheat", lwd=2)
ablineclip(v=4, lty=1, col="skyblue4", lwd=2)
ablineclip(v=5, lty=1, col="royalblue", lwd=2)
ablineclip(v=6, lty=1, col="pink1", lwd=2)
ablineclip(v=7, lty=1, col="oldlace", lwd=2)
...
dataframe01 <- read.csv('D:/BigDataAnalytics/Capitulo04/Arquivos/pibpercap.csv', 
                        stringsAsFactors = F)

dataframe_1982 <- subset(dataframe01, ano == 1982)
plot(expectativa ~ pibpercap, data = dataframe_1982, log = "x")
View(dataframe01)
...
plot(expectativa ~ pibpercap, data = dataframe_1982, log = "x", col = mycol[continente])
