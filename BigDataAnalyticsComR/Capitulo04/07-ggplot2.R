...
# Oferece mais opções de modificações, legendas prontas e formatação mais sólida.
...
# Plota um gráfico básico com qplot()
...
# Contruói um modelo de regressão
...
# É possível mapear o tamanho dos pontos a uma variável de interesse:
