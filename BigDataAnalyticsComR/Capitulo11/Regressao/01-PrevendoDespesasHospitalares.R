...
setwd("D:/BigDataAnalytics/Capitulo11/Regressao")
getwd()
...
despesas <- read.csv("D:/BigDataAnalytics/Capitulo11/Regressao/despesas.csv")
View(despesas)

# Etapa 2: Explora e Prepara os Dados
...
# Etapa 3: Treina o Modelo (usando os dados de treino)
...
# Preve despesas médicas 

?predict

# Aqui verificamos os gastos previstos pelo modelo que devem ser iguais aos dados de treino

previsao01 <- predict(modelo)
View(previsao01)

# Prevendo os gastos com Dados de teste

despesasteste <- read.csv("D:/BigDataAnalytics/Capitulo11/Regressao/despesas-teste.csv")
View(despesasteste)
previsao2 <- predict(modelo, despesasteste)
View(previsao2)

# Etapa 4: Avalia a Performance do Modelo
...
# Etapa 5: Otimiza a Performance do Modelo

# Adiciona uma variável com o dobro do valor das idades

despesas$idade2 <- despesas$idade ^ 2

# Adiciona um indicador para BMI >= 30
...
despesasteste <- read.csv("D:/BigDataAnalytics/Capitulo1/Regressao/despesas-teste.csv")
View(despesasteste)
