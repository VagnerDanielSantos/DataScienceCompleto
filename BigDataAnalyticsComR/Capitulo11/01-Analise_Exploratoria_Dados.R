...
setwd("D:/BigDataAnalytics/Capitulo11")
getwd()
...
carros <- read_csv("D:/BigDataAnalytics/Capitulo11/Arquivos/carros-usados.csv")
...
# Cria uma nova variável indicando cores conservadoras 
...
# Verifica o relacionamento entre 2 variáveis categóricas
# Cria uma crosstable 
